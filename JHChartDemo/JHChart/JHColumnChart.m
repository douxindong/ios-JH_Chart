...
/** index */
@property (nonatomic,assign) NSIndexPath *index_Path;
@end
...
-(void)showAnimation{
    ...
    if (_needXandYLine) {
        ...
        for (NSInteger i = 0; i<5; i++) {
            ...
            textLayer.contentsScale = 3;//解决字体模糊❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️
...
//            CGFontRelease(fontRef);
    ...
    for (NSInteger i = 0; i<_valueArr.count; i++) {
        ...
        for (NSInteger j = 0; j<arr.count; j++) {
            ...
            UIButton *itemsView = [UIButton new];
            ...
            [UIView animateWithDuration:1 animations:^{
                ...
                itemsView.tag = i;
                [itemsView addTarget:self action:@selector(itemViewClick:) forControlEvents:UIControlEventTouchUpInside];
...
//    NSLog(@"点击的第%ld个",(long)sender.tag);
    if (self.tapClickBlock) {
         self.tapClickBlock(sender.tag);
    }
   
}

- (void)tapClick:(tapClickBlock)indexblock {
    self.tapClickBlock = indexblock;
}
-(void)clear{
